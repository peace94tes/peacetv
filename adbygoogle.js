...
let ss2 = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MNCSports2-HD/sa_dash_vmx/MNCSports2-HD.mpd';
let ss1 = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MNCSports-HD/sa_dash_vmx/MNCSports-HD.mpd';
let spotv= 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/SPOTV-HD/sa_dash_vmx/SPOTV-HD.mpd';
let spotv2= 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/SPOTV2-HD/sa_dash_vmx/SPOTV2-HD.mpd';
let fight= 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/FightSports/sa_dash_vmx/FightSports.mpd';


//LOKAL
let oktv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/OKTV/sa_dash_vmx/OKTV.mpd';
let mnctv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MNCTV-HD/sa_dash_vmx/MNCTV-HD.mpd';
let rcti = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/RCTI-DD/sa_dash_vmx/RCTI-DD.mpd';
let gtv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/GTV-HD/sa_dash_vmx/GTV-HD.mpd';
let inews = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/iNewsTV-HDD/sa_dash_vmx/iNewsTV-HDD.mpd';
let trans7 = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Trans7-2/sa_dash_vmx/Trans7-2.mpd';
let transtv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/TransTV-2/sa_dash_vmx/TransTV-2.mpd';
let antv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/ANTV/sa_dash_vmx/ANTV.mpd';
let tvone = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/TVOne/sa_dash_vmx/TVOne.mpd ';
let metrotv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Metro-TV2/sa_dash_vmx/Metro-TV2.mpd';
let tvri = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/PemersatuBangsa/sa_dash_vmx/PemersatuBangsa.mpd';
let kompas = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/KompasTV/sa_dash_vmx/KompasTV.mpd';
let rtv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/RTV/sa_dash_vmx/RTV.mpd';
let net = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/NetTV-HD/sa_dash_vmx/NetTV-HD.mpd';


//MOVIES
let tvn_movies = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/tvNMovies/sa_dash_vmx/tvNMovies.mpd';
let fmn = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/FMN/sa_dash_vmx/FMN.mpd';
let hits_movies = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/HitsMovies/sa_dash_vmx/HitsMovies.mpd';
let imc = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/IndonesiaMovieChannels-HD/sa_dash_vmx/IndonesiaMovieChannels-HD.mpd';
let galaxy = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Galaxy-HD/sa_dash_vmx/Galaxy-HD.mpd';
let galaxy_premium = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/GalaxyPremium-HD/sa_dash_vmx/GalaxyPremium-HD.mpd';
let thrill = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Thrill/sa_dash_vmx/Thrill.mpd';
let cinemaword = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/CinemaWorld/sa_dash_vmx/CinemaWorld.mpd';
let celestial_movies = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/CelestialMovie/sa_dash_vmx/CelestialMovie.mpd';
let celestial_clasic_movies = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/CelestialClassic/sa_dash_vmx/CelestialClassic.mpd';
let zee_bioskop = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/ZeeBIOSKOP/sa_dash_vmx/ZeeBIOSKOP.mpd';
let axn = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/AXN/sa_dash_vmx/AXN.mpd';
let cinemachi = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cinemachi-HD/sa_dash_vmx/Cinemachi-HD.mpd';
let cinemachi_action = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cinemachi-Action/sa_dash_vmx/Cinemachi-Action.mpd';
let cinemachi_kids = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cinemachi-Kids-HD/sa_dash_vmx/Cinemachi-Kids-HD.mpd';
let cinemachi_max = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cinemachi-Max-HD/sa_dash_vmx/Cinemachi-Max-HD.mpd';
let cinemachi_xtra = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cinemachi-Xtra-HD/sa_dash_vmx/Cinemachi-Xtra-HD.mpd';
let my_cinema = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MyCinema/sa_dash_vmx/MyCinema.mpd';
let my_cinema_asia = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MyCinema-Asia/sa_dash_vmx/MyCinema-Asia.mpd';
let my_family = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MyFamily/sa_dash_vmx/MyFamily.mpd';

//entertainment. https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MusicChannel/sa_dash_vmx/MusicChannel.mpd
let tvn = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/tvN/sa_dash_vmx/tvN.mpd';
let hits = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/HITS/sa_dash_vmx/HITS.mpd';
let musictv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/MusicChannel/sa_dash_vmx/MusicChannel.mpd';



//kids
let babytv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/BabyTV-NewHD/sa_dash_vmx/BabyTV-NewHD.mpd';
let kidstv = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/KidsChannel/sa_dash_vmx/KidsChannel.mpd';
let nickeloden = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Nickelodeon/sa_dash_vmx/Nickelodeon.mpd';
let animax = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Animax/sa_dash_vmx/Animax.mpd';
let my_kids = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/My-Kids/sa_dash_vmx/My-Kids.mpd';
let cebebies = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/Cbeebies/sa_dash_vmx/Cbeebies.mpd';
let nick_jr = 'https://local.starlive.workers.dev/https://melon-live-cdn.mncnow.id/live/eds/NickJr-HDD/sa_dash_vmx/NickJr-HDD.mpd';
...
document.addEventListener('shaka-ui-loaded', init33);
 ...
 document.addEventListener('shaka-ui-loaded', init35);
